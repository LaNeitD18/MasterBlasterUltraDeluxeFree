...
#define SKULL_BULLET_BBOX_OFFSET_RIGHT 5
#define SKULL_BULLET_BBOX_OFFSET_BOTTOM 5
#define SKULL_BULLET_BBOX_OFFSET_TOP -5
#define SKULL_BULLET_BBOX_OFFSET_LEFT -5
