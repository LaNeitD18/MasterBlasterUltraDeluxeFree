...
{
	JASONO_STATE_IDLE = 0x00,	// 
	JASONO_STATE_WALKING = 0x01,	// moving and touching ground

	JASONO_STATE_LOOKING_LEFT = 0x04,
	JASONO_STATE_GOING_UP = 0x05,
	JASONO_STATE_GOING_DOWN = 0x06,

	JASONO_STATE_DYING = 0x02,
	JASONO_STATE_DEAD = 0x80,
